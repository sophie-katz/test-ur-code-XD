...
// documentation.
#[doc(hidden)]
// Expect allowed because any failure to set the description is hard coded in, not dependent on how
...
mod tests {
    ...
    // The test path is only applicable on Unix
    //
    // TODO: This needs a Windows version
    #[cfg(target_family = "unix")]
    #[test]
